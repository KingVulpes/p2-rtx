...
int wmain(int argc, wchar_t* argv[])
{
	...
	std::wstring command_line = L"portal2.exe -novid -disable_d3d9_hacks -limitvsconst -softparticlesdefaultoff -disallowhwmorph -no_compressed_verts -nogamepadui +mat_phong 1";
